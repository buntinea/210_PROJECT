...
for this project to run, the argon and arduino must have their appropiate code flashed onto the device.
	...
	For the argon, i copied the code from "Argon_code" into a new file
	i flashed the code from the build.particle sight onto my device (https://www.youtube.com/watch?v=b6sUP16HWKM)
